...
type MultiSignReq struct {
	...
	Signatures    []types.StdSignature `json:"signatures"`
...
func MultiSignRequestHandlerFn(cliCtx context.CLIContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		newStdSig := types.StdSignature{Signature: cliCtx.Codec.MustMarshalBinaryBare(multisigSig), PubKey: multisigPub}
		newTx := types.NewStdTx(req.Tx.GetMsgs(), req.Tx.Fee, []types.StdSignature{newStdSig}, req.Tx.GetMemo())
